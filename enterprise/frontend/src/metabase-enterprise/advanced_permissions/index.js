...
import { getImpersonatedPostAction, impersonationSlice } from "./reducer";
import {
  createThunkAction,
  createAction,
  handleActions,
...
if (hasPremiumFeature("advanced_permissions")) {
  ...
  PLUGIN_REDUCERS.advancedPermissionsPlugin = combineReducers({
    impersonations: impersonationSlice,
  });
}
